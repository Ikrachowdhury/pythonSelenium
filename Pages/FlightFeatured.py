...
class FlightFeaturedView:
    ...
    def get_first_element_from_table(self):
        ...
        air_from = self.find.get_table_element_xpath(self.TableArray, 0,
                                                     '/html/body/main/section/div[2]/div/div/div[1]/div[2]/table/tbody/tr/td[5]')
        air_to = self.find.get_table_element_xpath(self.TableArray, 0,
                                                   '/html/body/main/section/div[2]/div/div/div[1]/div[2]/table/tbody/tr/td[6]')
        return airline.text, air_from.text, air_to.text


class AddFlightFeatured:
    def __init__(self, driver):
        self.find = Util.ElementsUtil(driver)
        self.DropBoxName = None
        self.Price = self.find.element_by_xpath(
            "/html/body/main/section/div[2]/div/div/div[1]/div[2]/table/tbody/tr[5]/td[2]/input")
